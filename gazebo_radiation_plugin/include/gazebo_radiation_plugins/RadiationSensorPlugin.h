#ifndef gazebo_radiation_plugins_RadiationSensorPLUGIN_H
#define gazebo_radiation_plugins_RadiationSensorPLUGIN_H
...
class RadiationSensorPlugin : public SensorPlugin
{
  /// brief Constructor
  ...
  */
  ...
  private: std::shared_ptr<sensors::RadiationSensor> parentSensor;
...
#endif //gazebo_radiation_plugins_RadiationSensorPLUGIN_H
